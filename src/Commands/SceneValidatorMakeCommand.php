...
class SceneValidatorMakeCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'module:make-scene-validator';
    ...
    protected function getTemplateContents(): mixed
    {
        ...
        return (new Stub('/request/scene-validator.stub', [
    ...
    {
        return Str::studly('scene-validator');
    }
}
